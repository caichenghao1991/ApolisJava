...
<% 
session.setAttribute("1",request.getParameter("section1"));
session.setAttribute("2",request.getParameter("section2"));
session.setAttribute("3",request.getParameter("section3"));
session.setAttribute("4",request.getParameter("section4"));
session.setAttribute("5",request.getParameter("section5"));
session.setAttribute("6",request.getParameter("section6"));
%> 
</body>
</html>